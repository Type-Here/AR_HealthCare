Shader "HoloMed/PanelBGLight"
{
    Properties
    {
        _MainTex         ("Sprite Texture",   2D)    = "white" {}

        _BaseColor       ("Base Color",       Color) = (0.710, 0.878, 0.969, 0.88)  // Sky Blue
        _TopColor        ("Top Color",        Color) = (0.940, 0.980, 1.000, 0.92)  // near-white

        _VignetteColor   ("Vignette Color",   Color) = (0.165, 0.373, 0.647, 0.25)
        _VignetteRadius  ("Vignette Radius",  Range(0,1))   = 0.60
        _VignetteSmooth  ("Vignette Smooth",  Range(0.01,1))= 0.55

        _GridColor       ("Grid Color",       Color) = (0.000, 0.176, 0.502, 0.05)
        _GridTiling      ("Grid Tiling",      Vector)= (20, 8, 0, 0)
        _GridWidth       ("Grid Line Width",  Range(0,0.5))= 0.04

        _HeaderColor     ("Header Color",     Color) = (0.532, 0.769, 0.918, 0.95)
        _HeaderHeight    ("Header Height",    Range(0,0.5))= 0.14

        _BorderColor     ("Border Color",     Color) = (0.024, 0.298, 0.647, 0.45)
        _BorderWidth     ("Border Width",     Range(0,0.08))= 0.012
        _BorderBright    ("Border Brightness",Range(0,3))   = 0.80

        _BracketColor    ("Bracket Color",    Color) = (0.024, 0.298, 0.647, 0.80)
