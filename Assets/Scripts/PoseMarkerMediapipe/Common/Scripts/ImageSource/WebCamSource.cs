...
namespace Mediapipe.ARHealthCare
{
  public class WebCamSource : ImageSource
  {
    ...
    public override Mediapipe.Unity.RotationAngle rotation => !isPrepared ? Mediapipe.Unity.RotationAngle.Rotation0 : (Mediapipe.Unity.RotationAngle)webCamTexture.videoRotationAngle;
