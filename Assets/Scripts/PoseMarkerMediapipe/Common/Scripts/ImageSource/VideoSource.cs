...
namespace Mediapipe.ARHealthCare
{
  public class VideoSource : ImageSource
  {
    ...
    private VideoClip video
    {
      ...
      {
        _video = value;
        resolution = new ResolutionStruct((int)_video.width, (int)_video.height, (int)_video.frameRate);
      }
    }
    ...
    public override ResolutionStruct[] availableResolutions => video == null ? null : new ResolutionStruct[] { new ResolutionStruct((int)video.width, (int)video.height, (int)video.frameRate) };
