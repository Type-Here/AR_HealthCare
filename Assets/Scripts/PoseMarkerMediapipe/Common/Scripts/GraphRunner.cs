...
#pragma warning restore IDE1006
    ...
    public virtual ConfigType configType
    {
      get
      {
        if (Unity.GpuManager.IsInitialized)
        {
#if UNITY_ANDROID
    ...
    public Unity.RotationAngle rotation { get; private set; } = 0;
    ...
    protected void AddTextureFrameToInputStream(string streamName, Unity.Experimental.TextureFrame textureFrame, GlContext glContext = null)
    {
    ...
    protected void AssertResult<T>(Unity.OutputStream<T>.NextResult result)
    {
      if (!result.ok)
      {
    ...
    protected void AssertResult<T1, T2>((Unity.OutputStream<T1>.NextResult, Unity.OutputStream<T2>.NextResult) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
    }

    protected void AssertResult<T1, T2, T3>((Unity.OutputStream<T1>.NextResult, Unity.OutputStream<T2>.NextResult, Unity.OutputStream<T3>.NextResult) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
    ...
    protected void AssertResult<T1, T2, T3, T4>((Unity.OutputStream<T1>.NextResult, Unity.OutputStream<T2>.NextResult, Unity.OutputStream<T3>.NextResult, Unity.OutputStream<T4>.NextResult) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
      AssertResult(result.Item3);
    ...
    protected void AssertResult<T1, T2, T3, T4, T5>(
      (
        Unity.OutputStream<T1>.NextResult,
        Unity.OutputStream<T2>.NextResult,
        Unity.OutputStream<T3>.NextResult,
        Unity.OutputStream<T4>.NextResult,
        Unity.OutputStream<T5>.NextResult
      ) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
    ...
    protected void AssertResult<T1, T2, T3, T4, T5, T6>(
      (
        ...
        Unity.OutputStream<T4>.NextResult,
        Unity.OutputStream<T5>.NextResult,
        Unity.OutputStream<T6>.NextResult
      ) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
    ...
    protected void AssertResult<T1, T2, T3, T4, T5, T6, T7>(
      (
        ...
        Unity.OutputStream<T5>.NextResult,
        Unity.OutputStream<T6>.NextResult,
        Unity.OutputStream<T7>.NextResult
      ) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
    ...
    protected void AssertResult<T1, T2, T3, T4, T5, T6, T7, T8>(
      (
        ...
        Unity.OutputStream<T6>.NextResult,
        Unity.OutputStream<T7>.NextResult,
        Unity.OutputStream<T8>.NextResult
      ) result)
    {
      AssertResult(result.Item1);
      AssertResult(result.Item2);
    ...
    protected void InitializeCalculatorGraph()
    {
      ...
      {
        calculatorGraph.SetGpuResources(Unity.GpuManager.GpuResources);
      }
    }
    ...
    ///   In addition to that, <see cref="Unity.OutputStream" /> instances should be initialized.
    /// </remarks>
    /// <param name="config">
    ...
    protected void SetImageTransformationOptions(PacketMap sidePacket, ImageSource imageSource, bool expectedToBeMirrored = false)
    {
      ...
      var isInverted = Unity.CoordinateSystem.ImageCoordinate.IsInverted(rotation);
      ...
      if ((inputHorizontallyFlipped && inputVerticallyFlipped) || rotation == Unity.RotationAngle.Rotation180)
      {
        inputRotation = inputRotation.Add(Unity.RotationAngle.Rotation180);
